...
import { ArrowDown, ArrowRight, Clock3, Flame, Instagram, Leaf, Sparkles, Zap } from "lucide-react";
import { Logo } from "@/components/icons";
import { RecipeExplorer } from "@/components/home-client";
import { getPublishedRecipes } from "@/lib/recipe-repository";
import { AnalyticsBeacon } from "@/components/recipe-experience";
import { BrandFilm } from "@/components/brand-film";
import { NewsletterForm } from "@/components/newsletter-form";
import { HomeHeader } from "@/components/home-header";

export const dynamic="force-dynamic";
export default async function Home() { const recipes=await getPublishedRecipes(); return <main><AnalyticsBeacon path="/"/>
  <HomeHeader />
  ...
  <footer><div><Logo/><p>La nouvelle énergie<br/>dans ton assiette.</p></div><div className="footer-links"><a href="#recettes">Recettes</a><Link href="/programme">Programme</Link><Link href="/favoris">Mes favoris</Link><a href="#manifeste">Manifeste</a><Link href="/mentions-legales">Mentions légales</Link><Link href="/confidentialite">Confidentialité</Link></div><div className="newsletter"><span>UNE BONNE RECETTE, CHAQUE DIMANCHE.</span><NewsletterForm/></div><div className="footer-bottom"><span>© 2026 PULSE FOOD STUDIO</span><span>FAIT AVEC DU GOÛT À PARIS</span><Instagram size={18}/></div></footer>
</main> }
