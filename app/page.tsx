...
export default function Home() { return <main>
  ...
  <footer><div><Logo/><p>La nouvelle énergie<br/>dans ton assiette.</p></div><div className="footer-links"><a href="#recettes">Recettes</a><a href="/admin">Studio créateur</a><a href="#manifeste">Manifeste</a><a href="#">Newsletter</a></div><div className="newsletter"><span>UNE BONNE RECETTE, CHAQUE DIMANCHE.</span><form><input placeholder="ton@email.fr"/><button aria-label="S'inscrire"><ArrowRight/></button></form></div><div className="footer-bottom"><span>© 2026 PULSE FOOD STUDIO</span><span>FAIT AVEC DU GOÛT À PARIS</span><Instagram size={18}/></div></footer>
</main> }
