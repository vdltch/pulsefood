...
export default async function Home() { const recipes=await getPublishedRecipes(); return <main><AnalyticsBeacon path="/"/>
  ...
  <footer><div><Logo/><p>La nouvelle énergie<br/>dans ton assiette.</p></div><div className="footer-links"><a href="#recettes">Recettes</a><a href="#programme">Collections</a><a href="#manifeste">Manifeste</a><Link href="/mentions-legales">Mentions légales</Link><Link href="/confidentialite">Confidentialité</Link></div><div className="newsletter"><span>UNE BONNE RECETTE, CHAQUE DIMANCHE.</span><form><input placeholder="ton@email.fr"/><button aria-label="S'inscrire"><ArrowRight/></button></form></div><div className="footer-bottom"><span>© 2026 PULSE FOOD STUDIO</span><span>FAIT AVEC DU GOÛT À PARIS</span><Instagram size={18}/></div></footer>
</main> }
